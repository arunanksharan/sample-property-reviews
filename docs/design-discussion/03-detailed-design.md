...
Hand-label a small review sample.
...
```text
priority = severity × frequency × recency × actionability × evidence_strength
```
...
## 21. Final stakeholder narrative
